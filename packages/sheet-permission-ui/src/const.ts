...
export const UNIVER_SHEET_PERMISSION_PANEL_LIST = 'UNIVER_SHEET_PERMISSION_PANEL_LIST';

export const UNIVER_SHEET_PERMISSION_PANEL_ADD_FOOTER = 'UNIVER_SHEET_PERMISSION_PANEL_ADD_FOOTER';
